...
| UAT-DEC-001 | Draft integrity decision is human-authored and evidence/calculation-linked. | Integrity Decision | Engineer | `POST /api/v1/integrity-decisions` | `integrity_decisions` | `integrity_decision.created/drafted` | covered |
