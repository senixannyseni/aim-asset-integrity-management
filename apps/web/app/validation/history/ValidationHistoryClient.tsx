    ...
    <main className="app-shell">
      ...
      <section className="panel">
        ...
        <div className="form-grid">
          <label><span>asset_id</span><input value={filters.asset_id} onChange={(event: ChangeEvent<HTMLInputElement>) => setFilters((current) => ({ ...current, asset_id: event.target.value }))} /></label>
