...
export default function AssetDetailClient({ assetId }: { assetId: string }) {
  ...
  return <main className="app-shell">
    ...
    {readiness && <>
      ...
      <TraceTable title="Evidence Coverage" rows={evidenceRows} emptyMessage="Direct same-asset evidence linked to the asset integrity package." />
      <TraceTable title="Inspection History" rows={context.inspection_events ?? []} emptyMessage="Inspection events linked to this asset." />
      <TraceTable title="NDT Measurement Coverage" rows={context.ndt_measurements ?? []} emptyMessage="NDT measurements linked to this asset." />
      <TraceTable title="Findings / Anomalies" rows={context.findings ?? []} emptyMessage="Findings raised for this asset." />
      <TraceTable title="Calculation Runs" rows={context.calculation_runs ?? []} emptyMessage="Deterministic calculation runs using this asset context." />
      ...
      <TraceTable title="Integrity Decisions" rows={context.integrity_decisions ?? []} emptyMessage="Integrity decisions linked to this asset." />
      <TraceTable title="Reports and Work Orders" rows={[...(context.reports ?? []), ...(context.internal_work_orders ?? [])]} emptyMessage="Downstream reports and internal work-order fallback traceability." />
      <TraceTable title="Audit Timeline" rows={auditRows} emptyMessage="Audit events for the asset package and related engineering records." />
